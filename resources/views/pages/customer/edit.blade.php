	...
	<div class="form-group">
	  ...
	  <div class="col-sm-10">
		<div class="input-group">
		  ...
		  {!! Form::text('Customer', $customer->Customer, array('class' => 'form-control', 'placeholder' => 'Nama CP')) !!}
		</div>
	  </div>
	</div>
	<div class="form-group">
	  ...
	  <div class="col-sm-2">
		<div class="input-group">
		  <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
		  {!! Form::text('CustEmail', $customer->CustEmail, array('class' => 'form-control', 'placeholder' => 'Email CP')) !!}
		</div>
	  </div>
	</div>

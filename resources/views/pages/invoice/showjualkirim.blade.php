...
@section('title')
	View Invoice Jual Kirim
@stop

@section('content')
{!! Form::model($invoice, [
  'method' => 'post',
  'route' => ['invoice.updateshowjualkirim', $invoice->id]
]) !!}
<div class="row">
  <div class="col-xs-12">
    <div class="box box-info">
      <div class='form-horizontal'>
        <div class="box-header with-border">
          <h3 class="box-title">Invoice Jual Kirim Detail</h3>
        </div>
        <!-- box-header -->
        <div class="box-body with-border">
          ...
          <table id="datatables" class="table table-bordered table-striped table-responsive">
            ...
            <tbody>
              {!! Form::hidden('Invoice', $invoice->Invoice) !!}
							{!! Form::hidden('InvType', 'InvoiceKirim') !!}
          ...
          <div class="box-footer">
            ...
            <!-- Print Button -->
            <a href="{{route('invoice.BAKirim', $invoice->id)}}" button type="button" class="btn btn-default"><i class="fa fa-print"></i> Print Berita Acara</a>
            <a href="{{route('invoice.InvjKirim', $invoice->id)}}" button type="button" class="btn btn-default"><i class="fa fa-print"></i> Print Invoice</a>
            @if($invoice->PPN==1 && $invoice->PPNT==0 && ($invoice->Times!=0 || $invoice->TimesKembali!=0))
              <a href="{{route('invoice.InvjtKirim', $invoice->id)}}" button type="button" class="btn btn-default"><i class="fa fa-print"></i> Print Transport Invoice</a>
            @endif
            <!-- Submit Button -->

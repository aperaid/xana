      ...
      <div class='form-horizontal'>
        ...
        <div class="box-body with-border">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input id="Discount" name="Discount" type="text" class="form-control" placeholder="Rp. 10,000" value="{{'Rp '. number_format($invoice->Discount,0,',','.')}}" onKeyUp="tot()" autocomplete="off">
            </div>

    ...
    <div class="box box-info">
      ...
      <div class="box-body with-border">
        ...
        <table id="tb_viewinvoice_example1" name="tb_viewinvoice_example1" class="table table-bordered table-striped table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$SE}}</td>
              <td>{{$Days2}}</td>
              <td>{{round(((($end3 - $start3) / 86400)+1)/$Days2, 4)}}</td>
              <td>{{$periode->Quantity}}</td>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            {!! Form::text('Transport', 'Rp '. number_format($transport->Transport,0,',','.'), array('id' => 'Transport', 'class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Rp. 100,000', 'onKeyUp' => 'tot()')) !!}
          </div>
        </div>
        <!-- Discount Input -->
        <div class="form-group">

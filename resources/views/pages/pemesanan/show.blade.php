						...
						<div class="box-body">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												@endif
												<td>{{ $pemesananlist -> QTerima.'/'.$pemesananlist -> Quantity }}</td>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<a href="{{route('penerimaan.create', 'id='.$pemesanan->id)}}"><button type="button" style="margin-right: 5px;" @if ( $terimacheck )	class="btn btn-default pull-right" disabled	@else class="btn btn-success pull-right" @endif>Penerimaan</button></a>
									<a href="{{route('pemesanan.edit', $pemesanan->id)}}"><button type="button" style="margin-right: 5px;" @if ( $terimacheck )	class="btn btn-default pull-right" disabled	@else class="btn btn-primary pull-right" @endif>Edit</button></a>
					...
					<div class="tab-pane" id="penerimaan_tab">
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-12">
									<a href="{{route('pemesanan.index')}}"><button type="button" class="btn btn-default pull-left" style="margin-right: 5px;">Back</button></a>
									<a href="{{route('retur.create', 'id='.$pemesanan->id)}}">	<button type="button" style="margin-right: 5px;" @if ( $returcheck || ($qreturcheck->SumQuantity!=$qreturcheck->SumQTerima))	class="btn btn-default pull-right" disabled	@else class="btn btn-warning pull-right" @endif>Retur</button></a>

  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-body">
        ...
        <a href="{{route('po.edit', $po -> POCode )}}"><button type="button" class="btn btn-primary pull-right" @if ($pocheck == 1) disabled @endif >Edit</button></a>

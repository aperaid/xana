  ...
  <div class="col-md-12">
    <div class="box box-info">
      ...
      <div class="box-footer">
        ...
        <button type="submit" style="margin-right: 5px;" @if ( $checkproj == 1 || $checkpen == 1 )	class="btn btn-default pull-right" disabled	@else	class="btn btn-danger pull-right"	@endif onclick="return confirm('Delete Project?')">Delete</button>
